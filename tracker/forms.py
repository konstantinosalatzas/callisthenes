...
class UnitForm(forms.ModelForm):
    class Meta:
        model = Unit
        fields = ('name', 'unit_of_measurement', 'units', 'protein', 'carbs', 'fats', 'fiber', 'sodium', 'cost')
        widgets = {
            ...
            'fiber': forms.NumberInput(attrs={'type': 'number', 'min': '0', 'step': '0.1', 'class': 'form-control'}),
            'sodium': forms.NumberInput(attrs={'type': 'number', 'min': '0', 'step': '0.1', 'class': 'form-control'}),
